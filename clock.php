  ...
  <div class="container">
    ...
    <div class="row center">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/SPRzm8ibDQ8" title="YouTube video player"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
      </div>
      <div class="col-12 col-sm-12 col-md-12 col-lg-12">
        <h2 class="tittle">Sinopsis</h2>
        <p class="info2"><span>Estado de bienestar futurista, Alex (Malcolm McDowell),
            un joven despiadado, duerme todo el día y pasa las noches vagando por la ciudad con sus droogs (amigos),
            atacando a personas inocentes en las calles y en sus hogares.
            Finalmente, capturado por la policía, Alex sufre una
            rehabilitación en forma de terapia de aversión tan brutal y
            horripilante como cualquiera de sus delitos.
          </span>
        </p>
        <p class="info2"><span>REPARTO: MALCOM MCDOWELL, PATRICK MAGEE, ADRIANNE Corri.
          </span>
        </p>
        <p class="info2">
          <span>
        ...
        <p class="info2"><span>Crimen - 1971 - 2h 17min.
          </span>
        </p>
      </div>
    </div>
